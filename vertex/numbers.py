...
class Numbers():
    ...
    @staticmethod
    def null(size=0, pos=0, number=0):
        pass

    @staticmethod
    def zero(size=0, pos=(0, 0), number=0):
        width = size * SIZE_MULTIPLIER
        Line(ellipse=(pos[0] - size / 4, pos[1] - size / 2, size / 2, size), width=width)

    @staticmethod
    def one(size=0, pos=(0, 0), number=0):
        points = []
    ...
    @staticmethod
    def two(size=0, pos=(0, 0), number=0):
        points = []
    ...
    @staticmethod
    def three(size=0, pos=(0, 0), number=0):
        width = size * SIZE_MULTIPLIER
    ...
    @staticmethod
    def four(size=0, pos=(0, 0), number=0):
        points = []
    ...
    @staticmethod
    def five(size=0, pos=(0, 0), number=0):
        points = []
        points.append((pos[0] + size / 4, pos[1] + size / 2))
        points.append((pos[0] - size / 4, pos[1] + size / 2))
    ...
    @staticmethod
    def six(size=0, pos=(0, 0), number=0):
        width = size * SIZE_MULTIPLIER
        points = []
        points.append((pos[0] - size / 4, pos[1] - size / 4))
        points.append((pos[0] - size / 4, pos[1] + size / 4))
    ...
    @staticmethod
    def seven(size=0, pos=(0, 0), number=0):
        width = size * SIZE_MULTIPLIER
        points = []
        points.append((pos[0] - size / 4, pos[1] + size / 2))
        points.append((pos[0] + size / 4, pos[1] + size / 2))
    ...
    @staticmethod
    def eight(size=0, pos=(0, 0), number=0):
        width = size * SIZE_MULTIPLIER
        Line(width=width, circle=(pos[0], pos[1] + size / 4, size / 4))
        Line(width=width, circle=(pos[0], pos[1] - size / 4, size / 4))

    @staticmethod
    def nine(size=0, pos=(0, 0), number=0):
        width = size * SIZE_MULTIPLIER
        points = []
        points.append((pos[0] + size / 4, pos[1] - size / 4))
        points.append((pos[0] + size / 4, pos[1] + size / 4))
